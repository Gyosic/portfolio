...
export function Project({ projects, lng }: ProjectProps) {
  ...
  return (
    // PROJECT PAGE
    <div className="relative flex h-full w-full flex-col items-start gap-5 overflow-y-auto overflow-x-hidden px-40 pt-14 pb-4 max-sm:justify-start max-md:p-4 max-md:pt-20">
      ...
      <div className="grid w-full grid-cols-3 gap-3 max-lg:grid-cols-1 max-xl:grid-cols-2">
